"""Merge de denuncias con datos demográficos por UBIGEO."""
...
try:
    ...
    print("   UBIGEOs convertidos a 6 dígitos con leading zeros")
...
try:
    ...
    if nulos_poblacion == 0:
        print("   Sin valores nulos en POBLACION_TOTAL")
    else:
        print(f"   Advertencia: {nulos_poblacion} valores nulos en POBLACION_TOTAL")
...
print("   Integridad validada: todos los datos demográficos presentes")
